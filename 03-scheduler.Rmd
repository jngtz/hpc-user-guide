...
This application takes care of the execution queue while accounting for other running processes.
...
- In combination with [drake](https://github.com/ropensci/drake) you are able to reproducible track already built targets and parallelize the building of intermediate targets
