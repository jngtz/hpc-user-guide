...
1. Note that working on a Linux server also requires a certain amount of familiarity with UNIX command-line shells and text editors.
There are dozens of Linux online tutorials which should help to get you started.
...
1. Please add a SSH key to your account to be able to login without password.
