...
The cluster consists of multiple different computing machines.

Group "**threadripper**":

- CPU: AMD Threadripper 2950X, 16-core, Hyperthreading, 3.5 GHz - 4.4 GHz
- RAM: 126 GB DDR4 
- Number of nodes: 3 c[0-2] (+ frontend)

Due to management overhead, only 8 cores (16 CPUs) are allowed to be used on the frontent.

Group "**opteron**":

- CPU: AMD Opteron 6172, 48 cores, no Hyperpthreading, 2.1 GHz
- RAM: 193 GB DDR3
- Number of nodes: 3 (c[3-6])
...
_Jupiter_ server (141.35.159.87) is set up as a web-server.
