...
Libraries can be loaded via `module load <module>`.
...
```sh
module load gdal-3.0.1-gcc-9.2.0-2rbxot
module load geos-3.7.2-gcc-9.2.0-hn6gflr
module load proj-5.2.0-gcc-9.2.0-az6mkj
...
R is not managed via Spack as it causes some problems with the RStudio Server.
...
```sh
alias r352="export R_HOME=/opt/R/3.5.2/lib64/R && radian"
alias r353="export R_HOME=/opt/R/3.5.3/lib64/R && radian"
alias r360="export R_HOME=/opt/R/3.6.0/lib64/R && radian"
alias r361="export R_HOME=/opt/R/3.6.1/lib64/R && radian"
```
