...
The installation path of GRASS GIS is here: `/opt/spack/opt/spack/linux-centos7-x86_64/gcc-7.3.0/grass-7.6.1-koiklsmbsephjov2yhjer3osmuf7hjuo/grass76`.

Using package `link2GI` the init call would look like

```r
link2GI::linkGRASS7(x = RQGIS::dem, search_path = "/opt/spack", quiet = FALSE)
```
