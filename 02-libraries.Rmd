...
(It is not strictly required to load a specfic version with the specification of a compiler.
...
Is not yet useable because Shiny Server requires an R interpreter being available on a user basis when starting an application. 
