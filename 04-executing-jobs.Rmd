...
# If you want to have pandoc and GDAL support on the workers, you need to initialize both the same way as on the frontend node. See the respective sections in the user guide.

# add more spack libraries here

CMQ_AUTH={{ auth }} /opt/R/<version>/bin/R --no-save --no-restore -e 'clustermq:::worker("{{ master }}")'
```
