...
Once you did this, you should be able to run the [example](https://github.com/mschubert/clustermq) listed at the top of the README of the _clustermq_ package.
...
It will then be passed to the `slurm_clustermq.tmpl` file which has the following lines:
